...
.setAction(async (args, hre) => {
  ...
  const pack = require('../packs/balancer_mainnet.dpack.json')  // reference deployment for mocks
  ...
  const mockpath = path.join(__dirname, `../packs/balancer_${hre.network.name}.dpack.json`)
